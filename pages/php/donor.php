        ...
        <div class="container">
            <form class="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="hospital" placeholder="Place and date of birth">
                </div>
        
                <div class="form-group">
                    <label for="city">Gender</label>
                    <input type="text" id="city" placeholder="Male/Female">
                </div>
        
                <div class="form-group">
                    <label for="location">Blood donor location & additional information</label>
                    <textarea id="location" placeholder="Where blood donations take place"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="city" placeholder="Enter weight">
                </div>
                
                <div class="form-group">
                    <label for="city">Age</label>
                    <input type="text" id="city" placeholder="Enter age">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contact-name" placeholder="Name of the patient's companion">
                </div>
